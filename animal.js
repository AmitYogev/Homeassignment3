...
function renderAnimal() {
  ...
  document.getElementById("weight").textContent = "Weight: " + chosenAnimal.weight;
  document.getElementById("height").textContent = "Height: " + chosenAnimal.height;
  document.getElementById("color").textContent = "Color: " + chosenAnimal.color;
  document.getElementById("habitat").textContent = "Habitat: " + chosenAnimal.habitat;
  document.getElementById("isPredator").textContent = "Predator: " + chosenAnimal.isPredator;
...
function renderRelatedAnimals() {
  ...
  const relatedArray = animals.filter(animal => {
    return animal.habitat === chosenAnimal.habitat && animal.name != chosenAnimal.name;
  })
...
function animalEscaped() {
  ...
  saveToLocalStorage('animals', ArrayWithoutObject(storageAnimals, chosenAnimal));
